      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><h4>User Divisi</h4></span>
              <span class="info-box-number">
                <a href="/settings/userdivisi/" class="small-box-footer">
                  <small>More info <i class="fa fa-arrow-circle-right"></i></small>
                </a>
              </span>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="ion ion-trophy"></i></span>

            <div class="info-box-content">
              <span class="info-box-text"><h4><?php echo $value; ?></h4></span>
              <span class="info-box-number">
                <a href="/ticket/index/<?php echo $key; ?>" class="small-box-footer">
                  <small>More info <i class="fa fa-arrow-circle-right"></i></small>
                </a>
              </span>
            </div>
