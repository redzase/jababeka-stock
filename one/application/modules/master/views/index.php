...
<div class="content-wrapper">
  <div class="container">
    ...
    <section class="content-header">
      <h1>
        Jababeka Control Center - Ticket - Master Data
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><h4>DIVISI</h4></span>
              <span class="info-box-number">
                <a href="divisi/" class="small-box-footer">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><h4>TYPE</h4></span>
              <span class="info-box-number">
