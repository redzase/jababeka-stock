          ...
          <div class="col-md-12">
              ...
              <div class="box-body">
                  ...
                  <p class="pull-right" style="margin-left:10px;">
                      <a href="<?php echo site_url('master/type/add/') ?>" class="btn btn-primary">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr class="<?php echo ($key % 2) == 0 ? "event" : "odd"; ?>">
                              ...
                              <td>
                                <a class="btn default btn-xs purple" href="<?php echo site_url("master/type/edit/". $value->id); ?>"><i class="fa fa-edit"></i> Edit </a>
                                <a class="btn default btn-xs black" href="<?php echo site_url("master/type/delete/". $value->id); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?');"><i class="fa fa-trash-o"></i> Delete </a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
