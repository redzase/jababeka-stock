...
<div class="content-wrapper">
  <div class="container">
    ...
    <section class="content-header">
      <h1>
      Divisi
        <small><?php echo strtolower($page); ?> divisi </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url("dashboard"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url("master/divisi/"); ?>">Divisi</a></li>
        <li class="active"><?php echo $page; ?> Divisi</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="box-footer">
                  <a href="<?php echo site_url("master/divisi/") ?>" class="btn btn-danger">Batal</a>
