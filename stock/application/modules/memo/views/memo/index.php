          ...
          <div class="col-md-12">
              ...
              <div class="box-body">
                  ...
                  <div id="timeline-visualization">
                    <?php if ($is_get and count($all_data_memo) == 0): ?>
  ...
  $(document).ready(function() {
    ...
    <?php foreach ($all_data_sector as $key => $value): ?>
     groups.add({
        ...
        content: '<a href="<?php echo site_url("memo/list/". $value->id); ?>"><?php echo addslashes($value->name); ?></a>'
      })   
    <?php endforeach; ?>

    var items = new vis.DataSet();
   
    <?php foreach ($all_data_memo as $key => $value): ?>
      items.add({
        id: <?php echo $value->id; ?>,
