...
<div class="content-wrapper">
  <div class="container">
    ...
    <section class="content-header">
      <h1>
      Pricelist
        <small><?php echo strtolower($page); ?> pricelist </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url("dashboard"); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Pricelist</a></li>
        <li class="active"><?php echo $page; ?> Pricelist</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="box-footer">
                  <a href="<?php echo site_url("pricelist/list/". $sector_id) ?>" class="btn btn-danger">Batal</a>
