...
<div id="myModal" class="modal">
  ...
  <iframe class="modal-content" id="img01" width="854" height="510" frameborder="0" allowfullscreen></iframe>
  <div id="caption"></div>
</div>
<div id="loading" class="modal">
  <img class="modal-content" style="width: 20%;margin-top: 15%;" id="img01" src="<?php echo base_url()?>static/images/loading.gif">
</div>


<div class="modal fade" id="pricelist" style="display: none;">
...
<footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2018 <a href="<?php echo site_url('dashboard') ?>">Jababeka Web</a></strong>
    </div>
    <!-- /.container -->
  </footer>
</div>
...
<!-- SlimScroll -->
<script src="<?php echo base_url()?>static/js/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
